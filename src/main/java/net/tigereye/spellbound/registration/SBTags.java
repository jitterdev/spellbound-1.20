...
public class SBTags {
    ...
    public static final TagKey<Enchantment> DAMAGE_ENCHANTMENTS = TagKey.of(Registries.ENCHANTMENT.getKey(), new Identifier(Spellbound.MODID,"damage"));
    public static final TagKey<Enchantment> EFFICIENCY_ENCHANTMENTS = TagKey.of(Registries.ENCHANTMENT.getKey(), new Identifier(Spellbound.MODID,"efficiency"));
    public static final TagKey<Enchantment> FORTUNE_ENCHANTMENTS = TagKey.of(Registries.ENCHANTMENT.getKey(), new Identifier(Spellbound.MODID,"fortune"));
    public static final TagKey<Enchantment> LOOTING_ENCHANTMENTS = TagKey.of(Registries.ENCHANTMENT.getKey(), new Identifier(Spellbound.MODID,"looting"));
    public static final TagKey<Enchantment> LURE_ENCHANTMENTS = TagKey.of(Registries.ENCHANTMENT.getKey(), new Identifier(Spellbound.MODID,"lure"));
    public static final TagKey<Enchantment> META_ENCHANTMENTS = TagKey.of(Registries.ENCHANTMENT.getKey(), new Identifier(Spellbound.MODID,"meta"));
    public static final TagKey<Enchantment> PROTECTION_ENCHANTMENTS = TagKey.of(Registries.ENCHANTMENT.getKey(), new Identifier(Spellbound.MODID,"protection"));
    public static final TagKey<Enchantment> REPAIR_ENCHANTMENTS = TagKey.of(Registries.ENCHANTMENT.getKey(), new Identifier(Spellbound.MODID,"repair"));
    public static final TagKey<Enchantment> RETALIATION_ENCHANTMENTS = TagKey.of(Registries.ENCHANTMENT.getKey(), new Identifier(Spellbound.MODID,"retaliation"));
    public static final TagKey<Enchantment> UNBREAKING_ENCHANTMENTS = TagKey.of(Registries.ENCHANTMENT.getKey(), new Identifier(Spellbound.MODID,"unbreaking"));
    public static final TagKey<Enchantment> UTILITY_ENCHANTMENTS = TagKey.of(Registries.ENCHANTMENT.getKey(), new Identifier(Spellbound.MODID,"utility"));
